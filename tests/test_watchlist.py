...
same in-memory app fixture, same user/film fixtures, same happy-path /
duplicate / nonexistent-film coverage required by CONTRIBUTING.md.
"""
...
def test_get_watchlist_returns_newest_first(app, sample_user):
    ...
    (most recently added first) — the Comment 5 decision.
    """
    with app.app_context():
